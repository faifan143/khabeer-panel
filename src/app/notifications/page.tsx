...
export default function NotificationsPage() {
  ...
  return (
    <PermissionRoute requiredPermissions={[PERMISSIONS.NOTIFICATIONS_VIEW]}>
      <AdminLayout>
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">
                  {t("notifications.failedNotifications")}
                </CardTitle>
              ...
              <div className="flex items-center gap-4">
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  <SelectTrigger className="w-40">
                    <SelectValue
                      placeholder={t("notifications.filterByStatus")}
                    />
                  </SelectTrigger>
                  <SelectContent>
                ...
                >
                  <SelectTrigger className="w-40">
                    <SelectValue
                      placeholder={t("notifications.filterByAudience")}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">
                      {t("notifications.allAudience")}
                    </SelectItem>
                  ...
                  <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader className="border-b">
                      <DialogTitle className="text-xl font-semibold">
                        {t("notifications.createNewNotification")}
                      </DialogTitle>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-3">
                          <Button
                            type="button"
                            variant={
                              newNotification.targetAudience.includes(
                                "customers"
                              )
                                ? "default"
                                : "outline"
                                  ...
                                  {selectedNotification && (
                                    <div className="space-y-4">
                                      ...
                                      <div className="flex items-center justify-between text-sm">
                                        ...
                                        >
                                          {t(
                                            `notifications.status.${selectedNotification.status}`
                                          )}
                                        </Badge>
                                      </div>
                                      <div className="text-sm text-muted-foreground">
                                        {t("notifications.sentToRecipients", {
                                          count:
                                            selectedNotification.recipientsCount.toLocaleString(),
                                          date: formatDate(
