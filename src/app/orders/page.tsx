            ...
            {trend && (
              ...
              >
                {trend.isPositive ? (
                  ...
                  <Zap
                    className={`h-3 w-3 ${isRTL ? "ml-1" : "mr-1"} rotate-180`}
                  />
                )}
...
export default function OrdersManagementPage() {
  ...
  } = useAdminOrders(1, 1000); // Increased limit to get all orders
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : t("orders.failedToUpdateOrderStatus");
  ...
  const handleOrderComplete = async (orderId: number) => {
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : t("orders.failedToCompleteOrder");
      toast.error(errorMessage);
    }
  };
        ...
        <div className="space-y-8">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-full min-w-[200px]">
                    ...
                    <DropdownMenuItem
                      ...
                      className={`cursor-pointer ${
                        activeTab === "accepted" ? "bg-gray-100" : ""
                      }`}
                    >
                      {t("orders.accepted")}
                    </DropdownMenuItem>
                    ...
                    <DropdownMenuItem
                      ...
                      className={`cursor-pointer ${
                        activeTab === "completed" ? "bg-gray-100" : ""
                      }`}
                    >
                      {t("orders.completed")}
                    </DropdownMenuItem>
                          ...
                          >
                            <div className="space-y-1">
                              <div className="text-sm font-medium text-gray-900">
                                {order.service?.category?.state
                                  ? getLocalizedState(
                                      order.service.category.state,
                                      i18n.language as "en" | "ar"
                                    )
                                  : t("orders.notApplicable")}
                              </div>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground">
                      {searchTerm
                        ? t("orders.noOrdersMatch", { searchTerm })
                        : t("orders.noOrdersInStatus", { status: activeTab })}
                    </p>
                  </CardContent>
                </Card>
              )}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-lg font-semibold text-green-600">
                          {renderCurrency(selectedOrder.totalAmount)}
                        </div>
                      </div>
                      <div>
                        <Label className="text-sm font-medium">
                        ...
                        <div className="mt-1 text-lg font-semibold text-blue-600">
                          {renderCurrency(selectedOrder.commissionAmount)}
                        </div>
                      </div>
                    </div>
          ...
          >
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="acceptNotes" className="text-sm font-medium">
                    {t("orders.adminNotes")}
                  </Label>
                  <Textarea
                    id="acceptNotes"
            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  disabled={
                    rejectOrderMutation.isPending || !rejectReason.trim()
                  }
                >
