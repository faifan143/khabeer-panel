...
export const adminService = {
  ...
  getAllProviders: async () => {
    const response = await api.get<AdminProvidersResponse>("/admin/providers");
    return response.data;
  },
  ...
  approveVerification: async (id: string, notes?: string) => {
    const response = await api.put(`/admin/verifications/${id}/approve`, {
      notes,
    });
    return response.data;
  },
  ...
  rejectVerification: async (id: string, notes: string) => {
    const response = await api.put(`/admin/verifications/${id}/reject`, {
      notes,
    });
    return response.data;
  },
  ...
  uploadLegalDocuments: async (files: File[]) => {
    ...
    const response = await api.post(
      "/admin/settings/upload-legal-documents",
      formData,
      {
        headers: {
  ...
  uploadBannerImage: async (file: File) => {
    ...
    const response = await api.post(
      "/admin/settings/upload-banner-image",
      formData,
      {
        headers: {
          "Content-Type": "multipart/form-data",
  ...
  updatePaymentStatus: async (
    ...
    return await InvoiceService.updatePaymentStatus(
      id,
      paymentStatus,
      paymentMethod
    );
  ...
  checkVersionUpdate: async (
    version: string
  ): Promise<{ requiresUpdate: boolean; latestVersion?: AppVersion }> => {
