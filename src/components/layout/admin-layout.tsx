          ...
          >
            ...
            <div
              className={`flex items-center ${
                i18n.language === "ar" ? " space-x-3" : "space-x-3"
              }`}
            >
              ...
              >
                <DropdownMenuTrigger asChild>
                  <button
                    className={`flex items-center rounded-full p-2 hover:bg-accent transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ${
                      i18n.language === "ar" ? " " : "space-x-2"
                    }`}
                  >
